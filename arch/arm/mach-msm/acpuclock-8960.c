...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[0]  = { {  192000, PLL_8, 0, 2, 0x00 }, 1050000, 1050000, 1 },
        [1]  = { {  270000, PLL_8, 0, 2, 0x00 }, 1050000, 1050000, 1 },
	...
	[12] = { {  918000, HFPLL, 1, 0, 0x22 }, 1150000, 1150000, 6 },
	[13] = { {  972000, HFPLL, 1, 0, 0x24 }, 1150000, 1150000, 6 },
	[14] = { { 1026000, HFPLL, 1, 0, 0x26 }, 1150000, 1150000, 6 },
	[15] = { { 1080000, HFPLL, 1, 0, 0x28 }, 1150000, 1150000, 6 },
	[16] = { { 1134000, HFPLL, 1, 0, 0x2A }, 1150000, 1150000, 6 },
	[17] = { { 1188000, HFPLL, 1, 0, 0x2C }, 1150000, 1150000, 6 },
	[18] = { { 1242000, HFPLL, 1, 0, 0x2E }, 1150000, 1150000, 6 },
	[19] = { { 1296000, HFPLL, 1, 0, 0x30 }, 1150000, 1150000, 6 },
	[20] = { { 1350000, HFPLL, 1, 0, 0x32 }, 1150000, 1150000, 6 },
#else
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 1, {   270000, PLL_8, 0, 2, 0x00 }, L2(0),   925000 },
#endif
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	...
	{ 1, {   270000, PLL_8, 0, 2, 0x00 }, L2(0),   875000 },
#endif
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	...
	{ 1, {   270000, PLL_8, 0, 2, 0x00 }, L2(0),   825000 },
#endif
